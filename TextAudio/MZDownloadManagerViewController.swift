...
extension MZDownloadManagerViewController {
    ...
    func showAlertControllerForPause() {
        ...
        print("showAlertControllerForPause")
    ...
    func showAlertControllerForRetry() {
       ...
       // print("showAlertControllerForRetry")
    ...
    func showAlertControllerForStart() {
        ...
        print("showAlertControllerForStart")
...
extension MZDownloadManagerViewController: MZDownloadManagerDelegate {
    ...
    func downloadRequestFinished(_ downloadModel: MZDownloadModel, index: Int) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: MZUtility.DownloadCompletedNotif as String), object: downloadModel.book)
    ...
    func updateBadge()
    {
        ...
        {
            tabBarController?.tabBar.items?[2].badgeValue = String(downloadManager.downloadingArray.count)
        }
